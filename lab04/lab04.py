...
# We can also implement a similar method for the auxiliary information that is returned by step and reset. In our
# case, we would like to provide the manhattan distance between the agent and the target:
